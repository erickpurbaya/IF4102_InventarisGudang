                        ...
                        <table class="table table-bordered table-responsive-md table-striped">
								...
								<tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pt-3-half text-center"><?php echo anchor('HapusBarangController/hapus/'.$brg['kodebarangg'], '<button type="submit" class="btn btn-primary" style="width: 100px; background-color:rgb(33, 179, 33);">Konfirmasi</button>') ?> </td>
									</tr>
                                    <?php endforeach; ?>
								</tbody>
							</table>
